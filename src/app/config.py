...
RAG_PROMPT_FILE = PROMPTS_CONFIG.get("rag_answer_generation_file", "rag_answer_generation_prompt.txt")
DEFAULT_PROMPT_FILE = PROMPTS_CONFIG.get("default_answer_generation_file", "default_answer_generation_prompt.txt")